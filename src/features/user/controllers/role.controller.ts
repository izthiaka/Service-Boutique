...
import RoleParamsVerify from "../helpers/params_verify/role.params_verify"
...
export default class RoleController
    ...
    private verifyParams = new RoleParamsVerify()
    ...
    async index(req: Request, res: Response) {
        try {
            ...
            return this.success(res, 200, "La liste des roles", result)
        } catch (error: any) {
    ...
    async show(req: Request, res: Response) {
        try {
            ...
            return this.success(res, 200, "Détail d'un role", result)
        } catch (error: any) {
