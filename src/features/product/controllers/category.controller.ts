...
import ProductCategoryParamsVerify from "../helpers/params_verify/category.params_verify"
...
interface IProductManagerController extends IController {
    updatePicture(req: Request, res: Response): any
    resetPicture(req: Request, res: Response): any
}

const staticUrlImage = "images/products/categories"

export default class ProductCategoryController
    extends ApiResponse
    implements IProductManagerController {
    private verifyParams = new ProductCategoryParamsVerify()
