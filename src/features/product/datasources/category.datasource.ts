import { ProductCategoryEntity } from "../schemas/category"

import OptionPagination from "../../../core/utils/option_pagination"

import IDatasource from "../../../core/interfaces/interface_datasource"

export interface IDatasourceProductCategory extends IDatasource {
    isExiste(match: object): Promise<boolean>
}

export default class ProductCategoryDatasource
    implements IDatasourceProductCategory {
    constructor(private schema = ProductCategoryEntity) { }
